...
namespace Drupal\kickstart\Installer\Form;
 ...
 */
class KickstartDemoInstallForm extends FormBase {
  ...
  public function getFormId() {
    return 'kickstart_demo_install_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['install_demo_content'] = [
      ...
      '#description' => $this->t('Check this box to install demo content.'),
      '#default_value' => TRUE,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // "drush si kickstart kickstart_demo_install_form.install_demo_content=0".
    ...
    if ($demo_content) {
      $this->moduleInstaller->install(['kickstart_content']);
